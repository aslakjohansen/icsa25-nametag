...
\newcommand{\ColCenter}[1]{\border/2+(\paperwidth-\border)/5*(#1+0.5)}
...
\newcommand{\StaticMaterial}[0]{
  \begin{tikzpicture}[remember picture,overlay]
    ...
    \node[anchor=center,text=black]
      at ([xshift=\ColCenter{0},yshift=-15mm/2] current page.north west)
      {\textsl{sponsor 1}};
    \node[anchor=center,text=black]
      at ([xshift=\ColCenter{1},yshift=-15mm/2] current page.north west)
      {\textsl{sponsor 2}};
%    \node[anchor=center,text=black]
%      at ([xshift=\ColCenter{2},yshift=-15mm/4] current page.north west)
%      {\textsl{sponsor}};
    \node[anchor=center,text=black]
      at ([xshift=\ColCenter{3},yshift=-15mm/2] current page.north west)
      {\includegraphics[scale=0.05]{figs/umbraco_logo_blue_horizontal.pdf}};
    \node[anchor=center,text=black]
      at ([xshift=\ColCenter{4},yshift=-15mm/2] current page.north west)
...
%      at ([xshift=3.2mm,yshift=12mm+16mm+\border+13mm] current page.south)
    ...
    \node[anchor=north,text=white]
      at ([xshift=\ColCenter{0},yshift=12mm+16mm-\border/4] current page.south west)
      {\sffamily \textbf{Mon}};
    \node[anchor=north,text=white]
      at ([xshift=\ColCenter{1},yshift=12mm+16mm-\border/4] current page.south west)
      {\sffamily \textbf{Tue}};
    \node[anchor=north,text=white]
      at ([xshift=\ColCenter{2},yshift=12mm+16mm-\border/4] current page.south west)
      {\sffamily \textbf{Wed}};
    \node[anchor=north,text=white]
      at ([xshift=\ColCenter{3},yshift=12mm+16mm-\border/4] current page.south west)
      {\sffamily \textbf{Thu}};
    \node[anchor=north,text=white]
      at ([xshift=\ColCenter{4},yshift=12mm+16mm-\border/4] current page.south west)
      {\sffamily \textbf{Fri}};
  \end{tikzpicture}
}
...
\newcommand{\OptionWSI}[0]{
  \begin{tikzpicture}[remember picture,overlay]
    \node[
      ...
      at ([xshift=\ColCenter{0},yshift=12mm+16mm-\border/4-6mm] current page.south west)
      {\sffamily Workshop};
  \end{tikzpicture}
}
\newcommand{\OptionWSII}[0]{
  \begin{tikzpicture}[remember picture,overlay]
    \node[
      ...
      at ([xshift=\ColCenter{1},yshift=12mm+16mm-\border/4-6mm] current page.south west)
      {\sffamily Workshop};
  \end{tikzpicture}
}
\newcommand{\OptionConfI}[0]{
  \begin{tikzpicture}[remember picture,overlay]
    \node[
      ...
      at ([xshift=\ColCenter{2},yshift=12mm+16mm-\border/4-6mm] current page.south west)
      {\sffamily Conference};
  \end{tikzpicture}
}
\newcommand{\OptionConfII}[0]{
  \begin{tikzpicture}[remember picture,overlay]
    \node[
      ...
      at ([xshift=\ColCenter{3},yshift=12mm+16mm-\border/4-6mm] current page.south west)
      {\sffamily Conference};
  \end{tikzpicture}
}
\newcommand{\OptionConfIII}[0]{
  \begin{tikzpicture}[remember picture,overlay]
    \node[
      ...
      at ([xshift=\ColCenter{4},yshift=12mm+16mm-\border/4-6mm] current page.south west)
      {\sffamily Conference};
  \end{tikzpicture}
}
\newcommand{\OptionTour}[0]{
  \begin{tikzpicture}[remember picture,overlay]
    \node[
      ...
      at ([xshift=\ColCenter{2},yshift=12mm+16mm-\border/4-6mm*2] current page.south west)
      {\sffamily City Tour};
  \end{tikzpicture}
}
\newcommand{\OptionReception}[0]{
  \begin{tikzpicture}[remember picture,overlay]
    \node[
      ...
      at ([xshift=\ColCenter{2},yshift=12mm+16mm-\border/4-6mm*3] current page.south west)
      {\sffamily Reception};
  \end{tikzpicture}
}
\newcommand{\OptionGala}[1]{
  \begin{tikzpicture}[remember picture,overlay]
    \node[
      ...
      at ([xshift=\ColCenter{3},yshift=12mm+16mm-\border/4-6mm*2] current page.south west)
      {\sffamily Gala#1};
  \end{tikzpicture}
}
